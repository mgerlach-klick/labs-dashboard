...
(deftest data-table
  (dc/calculate-data-table @test-db dc/+dashboard-sections+ dc/+labsters+))
...
;;   (is
;;    (=
;;     (dc/calculate-section-sums dc/+dashboard-sections+ [{:dashboard.core/klick-billable {:display-name "Klick Billable", :value 0, :formatted-value "-"},
;;                                                       :dashboard.core/labs-billable {:display-name "Labs Billable", :value 0, :formatted-value "-"},
;;                                                       :dashboard.core/promo {:display-name "Promotion", :value 0, :formatted-value "-"},
;;                                                       :dashboard.core/admin {:display-name "Administration", :value 0, :formatted-value "-"},
;;                                                       :person/name "Yan",
...
;; (dc/ffind
;;  (dc/calculate-all @test-db dc/+dashboard-sections+ dc/+labsters+)
;;  :display-name "SUM")
